...
// Added from ourin-baileys: rich message senders (tables, code blocks, latex, links), purely additive
import { generateTableContentV2, generateListContent, generateCodeBlockContent, generateCodeBlockContentV2, generateLinkContent, generateLinkContentV2, generateLatexContent, generateLatexImageContent, generateLatexInlineImageContent, captureUnifiedResponse, generateUnifiedResponseContent, generateRichMessageContent } from '../Utils/rich-messages.js';
export const makeMessagesSocket = (config) => {
    ...
    // Added from ourin-baileys: update a group member's label (protocol message), purely additive
    ...
    return {
        ...
        getUSyncDevices,
        messageRetryManager,
        // Added from ourin-baileys: additive rich-message senders + member label update
        updateMemberLabel,
