...
export const makeMessagesRecvSocket = (config) => {
    ...
    const handleMessage = async (node) => {
        ...
        try {
            ...
            // TEMP DEBUG — remove after diagnosing the jid/lid issue.
            if (isJidGroup(msg.key.remoteJid)) {
                console.log('[JID-DEBUG] raw stanza attrs:', node.attrs);
                console.log('[JID-DEBUG] decoded key:', msg.key);
            }
            ...
            // TEMP DEBUG — remove after diagnosing the jid/lid issue.
            if (isJidGroup(msg.key.remoteJid)) {
                console.log('[JID-DEBUG] key AFTER swap:', msg.key);
            }
