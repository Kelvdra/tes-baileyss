...
// --- Added from ourin-baileys: builds the extra "biz"/native_flow node needed for certain
// interactive/order-response message types. Purely additive, does not touch any existing export.
